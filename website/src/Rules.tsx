                            ...
                            <div className="card mb-1">
                                ...
                                <div id="collapseOne" className="collapse" aria-labelledby="headingOne" data-parent="#accordion">
                                    <div className="card-body">
                                        ...
                                        <p className="mb-1" style={{ fontWeight: 600 }}>Domanda con risposta indicata sul sito del docente</p>
                                        ...
                                        <p className="mb-1" style={{ fontWeight: 600 }}>Domanda riguardo informazioni banali e già chieste precedentemente nella chat</p>
                                        <p className="mb-3 ml-3 mr-3">
                            ...
                            <div className="card mb-1">
                                ...
                                <div id="collapseTwo" className="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
                                    <div className="card-body">
                                        ...
                                        <p className="mb-1" style={{ fontWeight: 600 }}>Bestemmie e linguaggio vivace</p>
                                        <p className="mb-3 ml-3 mr-3">
                                        ...
                                        <p className="mb-1" style={{ fontWeight: 600 }}>Insulti e offese</p>
                                        <p className="mb-3 ml-3 mr-3">
                                        ...
                                        <p className="mb-1" style={{ fontWeight: 600 }}>Spam e offtopic</p>
                                        <p className="mb-3 ml-3 mr-3">
                                            Lo spam è vietato.
                            ...
                            <div className="card mb-1">
                                ...
                                <div id="collapseThree" className="collapse" aria-labelledby="headingThree" data-parent="#accordion">
                                    <div className="card-body">
                                        ...
                                        <p className="mb-1" style={{ fontWeight: 600 }}>Nome e username</p>
                                        <p className="mb-3 ml-3 mr-3">
                                        ...
                                        <p className="mb-1" style={{ fontWeight: 600 }}>Politica</p>
                                        <p className="mb-3 ml-3 mr-3">
