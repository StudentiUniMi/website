        ...
        <Container>
          <div className="d-flex flex-column justify-content-center" style={{ gap: 10 }}>
            ...
            <div className="d-flex justify-content-center">
              <Image id="not-found" alt="Not found" src={"/images/message/not-found.png"} objectFit={"contain"} width={250} height={250} />
            </div>

            <div className="d-flex flex-row justify-content-center" style={{ gap: 10 }}>
              <PrimaryButton text={locale?.notFound.buttonHomepage} style={buttonStyle} theme={theme} href="/" />
              <DefaultButton text={locale?.notFound.buttonGroups} style={buttonStyle} theme={theme} href={"/courses"} />
            </div>
          </div>
        </Container>
      </div>
