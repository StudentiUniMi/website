          ...
          <div className="mb-4">
            ...
            <Container>
              <div className="d-flex flex-column mt-4" style={{ gap: 20 }}>
                <div>
                  <div className="mb-2">
                    <Text variant="mediumPlus" styles={semibold}>
                      {locale?.rules.rules.toxicBehaviour.title}
                    </Text>
                  </div>
                  <div>
                    <Text variant="medium">{locale?.rules.rules.toxicBehaviour.description}</Text>
                  </div>
                </div>
                ...
                <div>
                  <div className="mb-2">
                    <Text variant="mediumPlus" styles={semibold}>
                      {locale?.rules.rules.chatInteraction.title}
                    </Text>
                  </div>
                  <div>
                    <Text variant="medium">
                      ...
                      <ul>
                        {locale?.rules.rules.chatInteraction.list.map((x) => (
                          <li>{x}</li>
                        ))}
                      </ul>
                    </Text>
                ...
                <div>
                  ...
                  <div className="mb-3">
                    <Text variant="medium">
                      ...
                      <ul>
                        {locale?.rules.rules.spam.list1.map((x) => (
                          <li>{x}</li>
                        ))}
                      </ul>
                    </Text>
                  ...
                  <div className="mb-3">
                    <Text variant="medium">
                      ...
                      <ul>
                        {locale?.rules.rules.spam.list2.map((x) => (
                          <li>{x}</li>
                        ))}
                      </ul>
                    </Text>
                  ...
                  <div>
                    <Text variant="medium">{locale?.rules.rules.spam.description3}</Text>
                  </div>
                </div>
                ...
                <div>
                  <div className="mb-2">
                    <Text variant="mediumPlus" styles={semibold}>
                      {locale?.rules.rules.sharedContent.title}
                    </Text>
                  </div>
                  <div>
                    <Text variant="medium">
                      <JsxParser
                        ...
                        jsx={locale?.rules.rules.sharedContent.description}
                      />
                    </Text>
                  </div>
                </div>
                ...
                <div>
                  <div className="mb-2">
                    <Text variant="mediumPlus" styles={semibold}>
                      {locale?.rules.rules.offTopic.title}
                    </Text>
                  </div>
                  <div>
                    <Text variant="medium">
                      <JsxParser
                        bindings={{ theme: theme, semibold: semibold }}
                        components={{ Text, Link }}
                        jsx={locale?.rules.rules.offTopic.description}
                      />
                    </Text>
                  </div>
                </div>
          ...
          <div className="mb-4">
            <div style={subHeader}>
              <Container className="d-flex flex-row align-items-center" style={{ gap: 5 }}>
                ...
                <Text variant="xLarge" styles={semibold}>
                  {locale?.rules.measures.title}
                </Text>
              </Container>
            </div>
            <Container>
              <div className="d-flex flex-column mb-3 mt-4" style={{ gap: 20 }}>
                <Text variant="medium">{locale?.rules.measures.description1}</Text>
                <Text variant="medium">{locale?.rules.measures.description2}</Text>
                <Text variant="medium">
              ...
              <div className="mb-2">
                <Text variant="mediumPlus" styles={semibold}>
                  {locale?.rules.measures.countermeasures.title}
                </Text>
                <Text variant="medium">
                  <ul>
                    {locale?.rules.measures.countermeasures.list.map((x) => (
                      <li>
                        <JsxParser bindings={{ theme: theme, semibold: semibold }} components={{ Text, Link }} jsx={x} />
                      </li>
                    ))}
                  </ul>
                </Text>
              ...
              <div className="mb-3 mt-4">
                <Text variant="medium">
                  <ul>
                    ...
                    <ul className="mb-3">
                      {locale?.rules.advices.subList.map((x) => (
                        <li>{x}</li>
                      ))}
                    </ul>
                    {locale?.rules.advices.list2.map((x) => (
                      <li>{x}</li>
                    ))}
                  </ul>
                </Text>
