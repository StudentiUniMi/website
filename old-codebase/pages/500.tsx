          ...
          <Container>
            <div className="d-flex flex-column justify-content-center" style={{ gap: 10 }}>
              ...
              <div className="d-flex flex-row justify-content-center" style={{ gap: 10 }}>
                <PrimaryButton text={locale?.serverErrorPage.buttonHomepage} style={buttonStyle} theme={theme} href="/" />
                <DefaultButton text={locale?.serverErrorPage.buttonGroups} style={buttonStyle} theme={theme} href={"/courses"} />
              </div>
            </div>
          </Container>
        </div>
