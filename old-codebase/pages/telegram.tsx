        ...
        <div className="telegram-title pt-4 pb-4">
          <Container className="mb-5">
            <div className="d-flex flex-row courses-title-content align-items-center" style={{ gap: 20, marginBottom: 30 }}>
              ...
              <h1>
                <Text variant="superLarge" styles={bold} style={{ lineHeight: 1.3 }}>
                  {locale?.telegram.title}
                </Text>
                <br />
              </h1>
            </div>
            ...
            <h2>
              <Text variant="xLargePlus" styles={semibold} style={{ lineHeight: 1.3 }}>
            ...
            <div style={quotesSectionStyle} className="telegramDoubleQuote">
              ...
              <div style={quotesStyle}>
                <Text variant="xLarge" styles={semibold} style={{ color: theme.palette.neutralSecondary, fontStyle: "italic" }}>
                  {locale?.telegram.doubleQuoteText1}
                </Text>
                <Text variant="xLarge" styles={semibold} style={{ color: theme.palette.neutralSecondary, fontStyle: "italic" }}>
                  {locale?.telegram.doubleQuoteText2}
                </Text>
                <Text variant="xLarge" styles={semibold} style={{ color: theme.palette.neutralSecondary, fontStyle: "italic" }}>
                  {locale?.telegram.doubleQuoteText3}
                </Text>
              </div>
            </div>
            ...
            <div className="mb-4">
              <Text variant="xLargePlus" styles={semibold} style={{ lineHeight: 1.3 }}>
                {locale?.telegram.text1}
              </Text>
            </div>

            <Text variant="xLargePlus" styles={bold} style={{ lineHeight: 1.3, color: theme.palette.themeDark }}>
              {locale?.telegram.text2}
            </Text>
          </Container>

          <div className="py-4 mb-5" style={{ backgroundColor: theme.palette.neutralLighter }}>
            <Container>
              <Text variant="xLargePlus" styles={bold} style={{ lineHeight: 1.3, color: theme.palette.redDark }}>
                {locale?.telegram.headerList}
              </Text>
            </Container>
          </div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 40 }}>
              <div style={elementStyle}>
                <div style={numberStyle}>
                  <Text variant="xxLarge" styles={bold} style={{ color: theme.palette.white }}>
                    1
                  </Text>
                </div>

                <Text variant="xLarge" styles={semibold}>
                  {locale?.telegram.listText1}
                </Text>
              </div>
          ...
          <Container className="mt-4 mb-4 text-center">
            <Text variant="superLarge" className="telegramText3" styles={bold} style={{ lineHeight: 1.3 }}>
              {locale?.telegram.text3}
            </Text>
            <br />
          </Container>
