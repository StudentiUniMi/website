    ...
    <>
      ...
      <section className="services pb-3">
        ...
        <div className="text-center mb-4" style={subHeader}>
          <Pivot selectedKey={selectedSubSection} onLinkClick={handleSubSectionChange} headersOnly={true} linkSize={"normal"} linkFormat={"tabs"}>
                  ...
                  <Col xl={4} lg={6} md={6} sm={12} xs={12} className="mb-3" key={i}>
                    <Link href={x.link ?? ""} className="text-decoration-none" styles={hoverStyle}>
                      <Card label={x.name?.it} horizontal tokens={cardTokens} style={{ border: "0px", maxWidth: "none", cursor: "pointer" }}>
                        ...
                        <Card.Section>
                          <Text variant="medium" style={{ color: theme.palette.themeDark, marginBottom: 5 }} styles={semibold}>
                            {x.name![language!]}
                          </Text>
                          <Text variant="small" style={{ marginTop: 0, color: theme.palette.black }}>
