...
export const getDegreeInformations = (degreeSlug: string): Array<DegreeInformation> =>
  getTempDegrees().find((tempDegree: TempDegree) => tempDegree.slug === degreeSlug)?.degreeInformations ?? []
