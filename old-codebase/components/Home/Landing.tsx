        ...
        <Row>
          <Col lg={4}>
            <div style={{ marginLeft: "auto", marginRight: "auto", maxWidth: 200 }} className="mb-2 mb-lg-0">
              <Image id="logo" src={"/logo/unimi500.png"} alt="Network logo" objectFit={"contain"} width={200} height={200} />
            </div>
          </Col>
          ...
          <Col lg={8}>
            ...
            <div className="mb-3">
              <h2>
                <Text variant="large">{locale?.homepage.section1.text2}</Text>
              </h2>
            </div>

            <DegreesMarquee isLoadingDegrees={props.isLoadingDegrees} degrees={props.degrees} />
          </Col>
        </Row>
      </Container>
    </div>
