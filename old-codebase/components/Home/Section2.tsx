      ...
      <Container>
        <Row>
          <Col lg={4} className="text-center mb-4 mb-lg-0">
            <Image src={"/images/home/2.png"} alt="Network main redirects" objectFit={"contain"} width={280} height={210} />
          </Col>

          <Col lg={8}>
            <div className="mb-4">
              <Text variant="xLarge" styles={bold}>
                {locale?.homepage.section3.header}
              </Text>
            </div>
            ...
            <div>
              <div className="mb-4">
                <div className="d-flex flex-row align-items-center" style={{ gap: 15 }}>
                  ...
                  <div>
                    <Text styles={semibold} variant="large">
                      {locale?.homepage.section3.part1.title}
                    </Text>
                  </div>
                </div>
                ...
                <div style={{ marginLeft: 56, marginTop: -5 }}>
                  <div className="mb-2">
                    <Text variant="medium">{locale?.homepage.section3.part1.description}</Text>
                  </div>
                  <DefaultButton
              ...
              <div className="mb-4">
                <div className="d-flex flex-row align-items-center" style={{ gap: 15 }}>
                  ...
                  <div>
                    <Text styles={semibold} variant="large">
                      {locale?.homepage.section3.part2.title}
                    </Text>
                  </div>
                </div>
                <div style={{ marginLeft: 56, marginTop: -5 }}>
                  <div className="mb-2">
                    <Text variant="medium">{locale?.homepage.section3.part2.description}</Text>
                  </div>
                  <DefaultButton
              ...
              <div>
                ...
                <div style={{ marginLeft: 56, marginTop: -5 }}>
                  <div className="mb-2">
                    <Text variant="medium">{locale?.homepage.section3.part3.description}</Text>
                  </div>
                  <DefaultButton
