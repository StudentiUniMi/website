      ...
      <Container>
        ...
        <Row className="justify-content-around">
          <Col className="text-center mb-5 mb-md-0" md={4}>
            <Image src={"/images/home/5_1.png"} alt="Representatives" objectFit={"contain"} width={170} height={160} />
          ...
          <Col className="text-center" md={4}>
            <Image src={"/images/home/5_2.png"} alt="Administrators" objectFit={"contain"} width={170} height={160} />
            <div className="mb-2 mt-2">
              <Text variant="medium" styles={semibold}>
