      ...
      <Container>
        <Row>
          <Col lg={4} className="text-center mb-4 mb-lg-0">
            <Image src={"/images/home/4.png"} alt="StudentiUniMi Wikipedia" objectFit={"contain"} width={250} height={187} />
          </Col>
            ...
            <div>
              <div className="mb-2">
                <Text variant="large" styles={semibold}>
                  {locale?.homepage.wikipediaSection.text2}
                </Text>
              </div>

              <div className="mb-3">
                <Text variant="medium">{locale?.homepage.wikipediaSection.text3}</Text>
              </div>

              <PrimaryButton
                href={preventVisibleHref(isPolicyAccepted, "https://wiki.studentiunimi.it/start")}
