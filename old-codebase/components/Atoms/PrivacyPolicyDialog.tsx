...
const PrivacyPolicyDialog = () => {
  ...
  return (
    <Dialog hidden={!isPolicyDialogOpen} onDismiss={togglePolicyDialog} dialogContentProps={dialogContentProps} modalProps={modelProps}>
      <div className="d-flex flex-column" style={{ gap: 10 }}>
        ...
        <div style={{ display: "flex", justifyContent: "center" }}>
          <Image src={"/images/privacy_policy.png"} alt="Privacy policy" objectFit={"contain"} width={250} height={176} />
        </div>
        ...
        <div className="p-3 d-flex flex-column" style={{ backgroundColor: theme.palette.neutralLighter, borderRadius: 8, gap: 10 }}>
          ...
          <div className="d-flex flex-row" style={{ gap: 5 }}>
            <DefaultButton
              ...
              theme={theme}
              text={locale?.privacyPolicy.privacyPolicy}
            ...
            <DefaultButton
              className="flex-grow-1"
              theme={theme}
              text={locale?.privacyPolicy.regulation}
              href="/rules"
              style={{ textDecoration: "none", padding: "20px 10px" }}
              iconProps={icon}
            />
      ...
      <DialogFooter>
        <PrimaryButton
          onClick={togglePolicyDialog}
          text={locale?.privacyPolicy.refuse}
          style={{ padding: 20, backgroundColor: theme.palette.redDark, borderColor: theme.palette.redDark }}
        />
