...
const StudentsAssociation = (props: Props) => {
  ...
  let primaryText: JSX.Element = (
    <TooltipHost content={name} calloutProps={calloutProps}>
      ...
      <Card.Section>
        ...
        <Text variant="small" styles={helpfulTextStyles} className="mb-2">
          <JsxParser
            ...
            components={{ Text, Link, Icon }}
            jsx={"<Icon iconName='AiOutlineInfoCircle' /> " + description}
          />
        </Text>

        {!isInviteLinkEmpty && (
          <PrimaryButton
            href={preventVisibleHref(isPolicyAccepted, studentsAssociation.external_url!)}
