...
const Footer = () => {
  ...
  const { theme, language, palette, isPolicyAccepted, changeTheme, changeLanguage, changePalette, togglePolicyDialog } = useContext(GlobalContext)
  ...
  /* Theme palette code */
  const colorCells: Array<{ id: string; label: string; color: string }> = palettes.map((x) => ({
    id: x.id,
    label: x.label,
    color: x.palette?.themePrimary,
  }))
  ...
  }, []) // TODO: Understand why the footer isn't updating properly using the global context

  return (
    <>
      <footer
        style={{ backgroundColor: appTheme.palette.neutralQuaternaryAlt, borderTop: "1px solid", borderColor: appTheme.palette.neutralLight }}
        className="pt-5 pb-5"
      >
                ...
                <div>
                  <Text variant="medium">
                    <ul className="list-unstyled mb-3">
                      ...
                      <li style={listElement}>
                        <Link href="https://www.google.com/maps/d/viewer?mid=1601q0wxFe22mtgotqZ7AJzrrWEOYfhs&ll=45.57712672502888%2C9.425802988620111&z=10">
              ...
              {clientRender && (
                <div className="mb-2 language-selector">
                  ...
                  <Text
                    ...
                    styles={language === "it" ? bold : regular}
                    onClick={() => {
                      if (language !== "it") changeLanguage("it")
                    }}
                  >
                    ITA
                  </Text>
                  ...
                  <Text
                    variant="medium"
                    style={{ cursor: "pointer" }}
                    styles={language === "en" ? bold : regular}
                    onClick={() => {
            ...
            <Col xl={3} lg={4} md={6} sm={12} xs={12}>
              <div>
                <Text variant="medium" styles={semibold}>
                  {locale?.settingsPanel.selectColor}
                </Text>
              </div>
              {clientRender && (
                <SwatchColorPicker
          ...
          <Row>
            <Col lg={7} sm={12} style={{ display: "table" }} className="center-mobile mb-2 mb-lg-0">
              <Text variant="medium" style={{ display: "table-cell", verticalAlign: "middle" }}>
                ...
                <Link href="https://cdn.studentiunimi.it/privacy-policy-IT.pdf" styles={semibold}>
                  Privacy policy
                </Link>
              </Text>
            </Col>
