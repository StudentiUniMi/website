...
const helmetIt: Helmet = {
  homepage: {
    title: "Network StudentiUniMi - Gruppi, servizi e molto altro",
    description:
      "Sito web ufficiale del Network StudentiUniMi: gruppi WhatsApp rimpiazziati da Telegram, servizi e molto altro. Il network più grande dell'Università degli Studi di Milano, gestito da studenti per gli studenti.",
  },
  courses: {
    title: "Gruppi, risorse e rappresentanti dei corsi di laurea | Network StudentiUniMi",
    description:
      "Gruppi Telegram, risorse e rappresentanti per tutti i corsi di laurea (triennali, magistrali, lauree a ciclo unico) dell'Università degli Studi di Milano. Entra, chiedi informazioni e conosci nuove persone grazie al Network StudentiUniMi.",
  },
  groups: {
    title: "Tutti i gruppi | Network StudentiUniMi",
    description: "Gruppi universitari, per gli annunci e associazioni studentesche dell'Università degli Studi di Milano.",
  },
  services: {
    title: "Servizi e link rapidi | Network StudentiUniMi",
    description:
      "Tutti i servizi e i link rapidi alle risorse dell'Università degli Studi di Milano: iscrizioni esami, verbalizzazioni voti, webmail, e molto altro. Un'alternativa veloce a UNIMIA.",
  },
  rules: {
    title: "Regolamento dei gruppi | Network StudentiUniMi",
    description:
      "Il regolamento ufficiale dei gruppi Telegram del Network StudentiUniMi, il più grande network studentesco dell'Università degli Studi di Milano.",
  },
  university: {
    title: "Informazioni dall'Ateneo, graduatorie e mappe universitarie | Network StudentiUniMi",
    description:
      "Rimani aggiornato con tutte le informazioni, graduatorie e mappe universitarie dell'Università degli Studi di Milano, offerto dal Network StudentiUniMi.",
  },
  organization: {
    title: "Chi siamo | Network StudentiUniMi",
    description:
      "Chi siamo? Scopri l'organizzazione dietro il Network StudentiUniMi, il più grande network studentesco dell'Università degli Studi di Milano.",
  },
  degreeLoaded: {
    title1: "Gruppi e risorse di ",
    title2: " | Network StudentiUniMi",
    description1: "Tutte le risorse e i link dei gruppi Telegram di ",
    description2: " dell'Università degli Studi di Milano, offerti dal Network StudentiUniMi.",
  },
  notFound: {
    title: "La pagina che stai cercando non esiste | Network StudentiUniMi",
    description: "Uh oh, non riusciamo a trovare la pagina che stai cercando. Forse puoi provare a tornare alla homepage e cercare da lì.",
  },
  serverError: {
    title: "Errore del server | Network StudentiUniMi",
    description: "Sembra che stiamo avendo problemi al server, prova a ricollegarti tra poco.",
  },
  telegram: {
    title: "Perché usiamo Telegram? | Network StudentiUniMi",
    description:
      "Quante volte avete cercato senza successo gruppi WhatsApp completamente inaccessibili e inutilizzabili? Date un'occhiata a tutte le motivazioni che ci hanno portato a usare Telegram come piattaforma a scopo universitario.",
  },
}
...
const localeIt: ILocalizationStrings = {
  ...
  notFound: {
    ...
    description:
      "Uh oh, non riusciamo a trovare la pagina che stai cercando. Forse puoi provare a tornare alla homepage oppure alla sezione dei gruppi e cercare da lì.",
  ...
  serverErrorPage: {
    ...
    description:
      "Cercheremo di risolvere il problema il prima possibile, nel frattempo torna pure in homepage o sulle altre pagine che mettiamo a disposizione.",
    buttonHomepage: "Homepage",
    buttonGroups: "Corsi di laurea",
  },
  privacyPolicy: {
    ...
    description:
      'Per continuare ed utilizzare i nostri gruppi e servizi è necessario <Text variant="medium" styles={semibold}>leggere e accettare</Text> la nostra privacy policy e il regolamento.',
  ...
  settingsPanel: {
    ...
    close: "Chiudi",
    coachMark: {
      text1: "Benvenuto sul nostro sito!",
      text2: "Qui puoi trovare alcune impostazioni che ti potrebbero servire. Per il resto, esplora liberamente i servizi che offriamo! :)",
      understood: "Capito!",
    },
  },
  homepage: {
    ...
    section1: {
      ...
      text2:
        "Comunicare è importante, ma può essere frustrante farlo sui grupponi WhatsApp lasciati a loro stessi. Abbiamo creato un gruppo Telegram per ogni corso di laurea dell'Università degli Studi di Milano per facilitare lo scambio di informazioni.",
    },
    section2: {
      title: "Ecco cosa mettiamo a disposizione",
      cards: {
        card1: {
          title: "Gruppi per i corsi di laurea",
          description:
            "Più di <Text styles={bold} variant='large' style={{ color: theme.palette.themeDark }}>600</Text> gruppi dedicati agli specifici corsi di laurea e corsi didattici UniMi!",
        },
    ...
    unimiaSection: {
      ...
      text2:
        "Essendo studenti, sappiamo quanto può essere frustrante dover cercare le risorse universitarie passando per decine di pagine che neanche caricano.",
      text3:
        "Per questo motivo, abbiamo realizzato una pagina che permette di raggiungere tutti i servizi universitari a portata di click, in aggiunta ad alcune guide, servizi e strumenti che abbiamo realizzato.",
      buttonText: "unimia.studentiunimi.it",
    },
    wikipediaSection: {
      text1: "Dai un'occhiata alla nostra Wikipedia",
      text2:
        "La Wiki è una sezione parallela al nostro sito web: permette di collaborare per quanto riguarda la condivisione di materiale e altre informazioni utili sui corsi didattici di tutti i corsi di laurea.",
      text3:
    ...
    adminsRepresentativesSection: {
      ...
      col1: {
        title: "Contatta un rappresentante",
        description: "Per contattare un rappresentante devi raggiungere la sezione apposita del sito web, e selezionare il tuo dipartimento.",
        buttonText: "Raggiungi la sezione",
      },
      col2: {
        title: "Contatta un amministratore",
        description: "Per vedere la lista di amministratori del tuo corso di laurea devi cercare quest'ultimo nella sezione apposita del sito web.",
        buttonText: "Raggiungi la sezione",
      },
    },
    faqsSection: {
  ...
  rules: {
    ...
    rules: {
      ...
      sharedContent: {
        ...
        description:
          "È vietato inviare contenuti NSFW (<i>Not Safe For Work</i>), ovvero materiale sessualmente esplicito, volgare o ritenuto potenzialmente offensivo dalla collettività. La responsabilità civile e penale per tutti i contenuti inviati sui gruppi Telegram è personale. Il Network si impegna, nei suoi limiti, a garantire il pieno rispetto della legalità.",
      },
      offTopic: {
        title: "Off-Topic",
    ...
    lastSection: {
      ...
      description:
        'Se sei interessato, <Text variant="medium" styles={semibold}><Link href="/organization">contatta un membro dello staff</Link>.</Text>',
    },
  },
  courses: {
    title:
      '<Text variant="mega" style={{ lineHeight: 1.3 }}>Trova tutti i <Text style={{ color: theme.palette.themePrimary, fontWeight: 700 }} variant="mega">gruppi</Text> e le <Text style={{ color: theme.palette.themePrimary, fontWeight: 700 }} variant="mega">risorse</Text> del tuo corso di laurea</Text>',
    ...
    groupsSection: {
      ...
      text3:
        "Tutto quello che devi fare è scrivere il nome del tuo corso di laurea qui sotto, e potrai accedere ai gruppi telegram dei tuoi corsi didattici e ad altre informazioni utili.",
    },
    degree: {
    ...
    contactAdmin:
      "<Icon iconName='FollowUser'/> Contatta un <Link href='/organization'>amministratore</Link> se vuoi essere aggiunto al gruppo, oppure chiedilo direttamente su <Link href='https://t.me/unimichat'>@unimichat</Link>.",
    ...
    wikiCard: {
      ...
      description:
        "I link alla Wiki di un corso didattico potrebbero portare a pagine non ancora compilate: è qui che potete contribuire iscrivendovi e aiutandoci a raccogliere faq e qualsiasi altro contenuto utile per i corsi didattici.",
  ...
  groups: {
    ...
    announcementsGroups: {
      ...
      description:
        "Abbiamo creato dei gruppi dedicati esclusivamente alla pubblicazione di annunci sia di ricerca che di offerta, come ad esempio per i libri ed appunti e le ripetizioni.",
    ...
    studentsAssociations: {
      ...
      description2:
        "Se vorresti la tua associazione studentesca aggiunta nella lista scrivi ad un <Link href='/organization'>membro dello staff</Link>.",
      card: {
  ...
  services: {
    text1:
      "<Text variant='mega' styles={semibold}>Tutti i <Text styles={bold} variant='mega' style={{ color: theme.palette.themePrimary }}>servizi</Text>, in un\'unica pagina</Text>",
    text2:
      "Abbiamo realizzato una pagina per centralizzare tutti i collegamenti inerenti all'Università degli Studi di Milano e rendere disponibili anche le guide, strumenti e servizi telematici che abbiamo realizzato.",
  ...
  extraGroups: {
    text1:
      "Cerchi un gruppo aggiuntivo in particolare? Qui è possibile trovare tutti quelli che abbiamo creato: ricordiamo che ci sono gruppi con regolamenti appositi ad esempio per la creazione di annunci per la vendita di materiali, quindi è consigliato leggere il messaggio di benvenuto in tal caso.",
  ...
  university: {
    ...
    representatives: {
      ...
      description:
        'Se sei un rappresentante che vorrebbe apparire qui per aiutare eventuali studenti <Text variant="medium" styles={semibold}><Link href="/organization">contatta un membro dello staff</Link></Text>.',
    },
    departmentSelect: "Seleziona un dipartimento",
  ...
  contributors: {
    ...
    text2:
      'Hai contribuito allo sviluppo del network e vorresti comparire in questa lista? Scrivi in privato a <Link href="https://t.me/giuseppetm">@giuseppetm</Link>.',
  },
  aboutUs: {
  ...
  telegram: {
    ...
    text1:
      "Se la maggior parte degli studenti usano WhatsApp è senza dubbio un motivo aggiuntivo per incoraggiare a spostarsi su una piattaforma più sicura, accessibile e adatta ad un mondo universitario.",
    ...
    text3:
      "Unisciti alle migliaia di studenti che hanno già effettuato la transizione a Telegram e contribuisci a creare un supporto per il futuro agli studenti che verranno dopo di te.",
    ...
    listText1:
      "I nuovi studenti che accedono ai gruppi non hanno accesso alla cronologia della chat, ed è una cosa impensabile per quelli dei corsi di laurea ma soprattutto dei corsi didattici! E no, un drive non sostituisce una chat lunga 4 o 5 anni o più!",
    listText2:
      "Gli studenti hanno i numeri di cellulare completamente esposti, un problema grave soprattutto per studenti e studentesse da facoltà umanistiche, che ogni giorno si trovano messaggi in chat e chiamate da estranei.",
    listText3:
      "I media non vengono salvati lato server (vuol dire che è necessario che chi ha mandato il file sia ancora disponibile), rendendoli completamente inaccessibili a futuri studenti. Per fare un esempio, con Telegram un file mandato su un gruppo rimane a disposizione per sempre.",
    listText4:
      "Non esiste moderazione e automatizzazione tramite utilizzo di bot; i gruppi WhatsApp vengono inondati ogni giorno di spam e messaggi off-topic che rendono impossibile comunicare e reperire informazioni utili.",
    ...
    listText6:
      "Accessibilità dei gruppi inesistente, di fatto vengono utilizzati i nostri servizi (che si trovano facilmente tramite motori di ricerca) per andare a trovare dei gruppi e risorse letteralmente introvabili, ahimè ironia della sorte.",
  },
  footer: [
    ...
    {
      header: "Contatti",
      text: "Per qualsiasi dubbio o proposta è possibile scrivere sul gruppo principale del network <Link href='https://t.me/unimichat'>@unimichat</Link>.",
    },
    { video: "Scaricare videolezioni", graduations: "Graduatorie", maps: "Mappe spazi universitari" },
  ],
}

export { localeIt, helmetIt }
