            ...
            LocalizationService.data = new LocalizedStrings<ILocalizationStrings>({
                it: {
                    ...
                    groups: {
                        ...
                        tutorsGroupDescription: 'Gruppo principale del dipartimento <Link href="https://orientamento.di.unimi.it/index.php/studia-con-noi/tutor-di-processo" target="_blank"><Text styles={semibold} variant="small">gestito dai tutor di processo</Text></Link>, per qualsiasi tipo di discussione inerente al corso di laurea.',
                ...
                en: {
                    ...
                    groups: {
                        ...
                        tutorsGroupDescription: 'Main group of the department <Link href="https://orientamento.di.unimi.it/index.php/studia-con-noi/tutor-di-processo" target="_blank"><Text styles={semibold} variant="small">managed by tutors</Text></Link>, for any kind of discussion concerning the degree course.',
